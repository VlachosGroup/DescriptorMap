...
#                                 interactions=interactions)
        ...
        mole_frac_conditions = [{'CH4': 0.006, 'O2': 0.01, 'HE': 0.984, 'PT(S)': 1.00},
                                {'CH4': 0.008, 'O2': 0.01, 'HE': 0.982, 'PT(S)': 1.00},
                                {'CH4': 0.010, 'O2': 0.01, 'HE': 0.980, 'PT(S)': 1.00},
                                {'CH4': 0.012, 'O2': 0.01, 'HE': 0.978, 'PT(S)': 1.00},
                                {'CH4': 0.014, 'O2': 0.01, 'HE': 0.976, 'PT(S)': 1.00}]
